## Can you range over a closed channel?

Short answer: YES — you can range over a closed channel in Go.

That’s actually the correct and intended pattern.

When you close a channel in Go:

- It signals “no more values will be sent”.
- Receivers can still receive remaining buffered values.
- Once the buffer is empty, further receives return the zero value and ok=false.
